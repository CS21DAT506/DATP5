plot_setups = {
    ...
    "Cost given as final distance to target (508R removed)":    {"data_key":"end_cost",                     "label": "Cost", "min": 0,  "max": 25000,   "unwanted_models": ["4:508R"]},
    ...
    "Mean squared error (168S removed)":                        {"data_key":"acc_se",                       "label": "Error", "min": 0,  "max": 200,    "unwanted_models": ["GCPD", "3:168S"]},
