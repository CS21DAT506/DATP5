...
if __name__ == "__main__":
    particles = [
        {"pos":(0,0,0),"vel": (0,0,0), "mass":300, "radius":0.1},    #Origo
        {"pos":(1,1.5,0),"vel": (-0.1,0,0), "mass":10, "radius":0.1},
        {"pos":(-1,1.7,0),"vel": (0.1,0,0), "mass":10, "radius":0.1},
    ]
    ...
    # fig, ax = rebound.OrbitPlot(sim, fancy=False, color=True)
    plt.show()
